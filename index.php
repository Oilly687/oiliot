...
$user_data = $response_channel->channel;
$user_data = array_slice($user_data, 0, 9);
foreach ($user_data as $user) {
	echo "Humidity: "channel->name;
	echo "<br />";
	echo "Temperature: "feeds[1]->field1;
	echo "<br /> <br />";
        echo "Created at: "feeds[1]->field2;
	echo "<br /> <br />";
	 echo "Created at: "feeds[1]->created_at;
	echo "<br /> <br />";
}
